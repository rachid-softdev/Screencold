    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-8 text-gray-600">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900">4. Cookies et technologies similaires</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900">5. Base légale du traitement</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900">7. Conservation des données</h2>
            <p className="mt-3">
